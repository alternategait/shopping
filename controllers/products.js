...
module.exports = { // as set up by todo routes line 15
    getProducts: async (req,res)=>{  // a promis syntax
        try{
            const safeProducts = await fragranceProduct.find().toArray() // variable connecting to Todo model then finding
            ...
            res.render('index.ejs', { products: safeProducts}) // respond with a render of 'todos.ejs pass todos info at variable written line 6 and left info as variable written line 7
